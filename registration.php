...
<div id="content">
    <div>
      <div id="center">
          ...
          <div class="text">
            <h1>&nbsp;</h1>
            <form action="registration.php" method="post" onsubmit="return chk_form(this)">
              <h1>&nbsp;</h1>
              <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                  <td valign="top"><div align="">
                      <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td colspan="2" valign="top"><p><strong>Get started with &nbsp;</strong> </p></td>
                        </tr>
                        <tr>
...
Examples: svihit<br />
                        ...
                        <tr>
                          ...
                          <td><p>
                              ...
                              <br />
                            If you forget your password we will ask for the answer to          your security question.</p>
                            <p>&nbsp;</p>
                            <p>&nbsp;</p></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><p>
                              ...
                              <br />
                            This address is used to authenticate your account should          you ever encounter problems or forget your password. If you do not have          another email address, you may leave this field blank.&nbsp;<a href="javascript:openWindow(%22SecondaryEmailHelp%22,700,%20450)">Learn More</a> </p>
                            <p>&nbsp;</p>
                            <p>&nbsp;</p></td>
                        </tr>
                        <tr>
...
if(isset($_POST['submit']))
{
	...
	{$fname=$_POST['FirstName'];
		...
		$secondaremail=$_POST['SecondaryEmail'];
		$email=$_POST['Email'];
		...
		//	echo "hello hi";
			 $query="insert into reg values('','$fname','$lname','$secondaryemail','$email','u')";
			$query1="insert into user values('','$email','$pass','u')";
